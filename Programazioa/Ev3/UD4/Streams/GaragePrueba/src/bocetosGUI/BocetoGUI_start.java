 ...
 * @author AdriAlex
 */
public class BocetoGUI_start extends javax.swing.JFrame {

    /**
     * Creates new form BocetoGUI_start
     */
    public BocetoGUI_start() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BocetoGUI_start.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BocetoGUI_start().setVisible(true);
            }
        });
    }
